          ...
          {showEmailLogin ? (
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 py-2 px-4 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition duration-200 font-medium"
              >
            ...
            <>
              <button
                ...
                className="w-full bg-sky-600 text-white py-2 px-4 rounded-lg hover:bg-sky-700 transition duration-200 font-medium mb-4"
              >
